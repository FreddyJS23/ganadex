...
export const TableCausasFallecimiento = ({ causas_fallecimiento }: ResponseCausasFallecimiento) => {
    return (
            ...
            <table className="table">
                ...
                <tbody>
                    {causas_fallecimiento.map(({ id, causa }) => (
                        <tr key={id}>
                            <td>{causa} </td>
                            <td><Link href={`/fallecimientos/causa/actualizar/${id}`}><IconEdit className="size-6" /></Link></td>
                        </tr>
                    ))}
                </tbody>
            </table>
