...
export const ModalCreateEditVaccine = (props: ModalCreateEditVaccineProps) => {
  ...
  const {
    ...
    defaultValues:props.type == "update" ? {...props.vaccine} : {
  ...
  const transfomedTypeCattleSelect =(typeCastle:Vaccine["tipos_ganado"] | null) => {
    ...
    const typesCattleTranformed:CreateVaccine["tipo_ganados"] = typeCastle.map((item)=>{
  ...
  const [tipoGanados, setTipoGanados] = useState<CreateVaccine["tipo_ganados"] | null>(
    type == "update" ? transfomedTypeCattleSelect(props.vaccine.tipos_ganado)?.typesCattleTranformed : null,
  );
  ...
  useEffect(() => { 
    if(props.type == "update") {
      setTipoGanados(transfomedTypeCattleSelect(props.vaccine.tipos_ganado)?.typesCattleTranformed)
    ...
    >
      ...
      >
        ...
        <GanadoTiposVacuna
          ...
          initialSelected={type == "update" ? transfomedTypeCattleSelect(props.vaccine.tipos_ganado)?.typesCattleTranformed : undefined}
        />
      </form>
    </LayoutModal>
  );
