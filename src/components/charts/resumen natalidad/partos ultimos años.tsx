...
type PartosUltimos5AñosProps = {
 ...
 const PartosUltimos5AñosLinea = forwardRef(function({nacimientos_ultimos_5_año} :PartosUltimos5AñosProps,ref:ForwardedRef<ChartJS<'line'>>) 
 {
    ...
    const extraerDatosUltimosAños = (
        ...
        nacimientos_ultimos_5_año.forEach(
            ({ año, partos_producidos }) => {
                years.push(año);
