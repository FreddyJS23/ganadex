...
export const ChangeSessionHacienda = ({ hacienda }: { hacienda: Hacienda }) => {
    ...
    return (
        <>
            ...
            <ButtonNextUI size='sm' color={'primary'} className='w-28 mt-1 ' onClick={onOpen} >
                Trabajar
            </ButtonNextUI>

      
            <ModalHaciendaSession isOpen={isOpen} onOpenChange={onOpenChange} hacienda={hacienda} />
        </>
    );
};
                    ...
                    <>
                        <ModalHeader className="flex flex-col gap-1">
                            ...
                            <p className="text-sm opacity-60">
                                Estás a punto de cambiar la sesión de trabajo
                                con esta hacienda
                            </p>
                        </ModalHeader>
                        <ModalBody>
                            ...
                            <div className="flex flex-col gap-4 py-4">
                                ...
                                <div className="text-sm opacity-60">
                                    Al cambiar la sesión por esta hacienda, podrás
                                    acceder a toda su información, gestionar sus
                                    recursos y realizar operaciones.
                                </div>
                            </div>
                        </ModalBody>
                        <ModalFooter>
