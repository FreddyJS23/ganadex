...
export const ButtonRestoreBd = ({ dateLastBackup }: ButtonRestoreBdProps) => {
    ...
    return (
        <>
            ...
            >
                <p>
                    El ultimo respaldo fue el <b>{dateLastBackup}</b>, desea
                    restaurarlo? Al realizar esta acción perderá la información
                    que se haya registrado posterior a la fecha del respaldo,
