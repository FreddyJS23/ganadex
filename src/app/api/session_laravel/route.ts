...
if (!xsrfToken || !laravelSession) return new Response(JSON.stringify({ error:{message: 'Ha ocurrido un error con los tokens del servidor, por favor vuelva a recargar la pagina' } }), { status: 500 })
