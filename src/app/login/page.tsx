...
export default function Page() {
    return (
        <>
            <div className="flex flex-col sm:flex-row max-w-5xl">
                {/* imagen android */}
                ...
                <div className="flex size-full z-10 pt-16 flex-col items-center rounded-lg gap-4  sm:bg-base-100 sm:p-4 sm:w-2/4 sm:h-[500px]">
                    <Logos small={false} />
