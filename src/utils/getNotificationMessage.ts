...
const notificationsArray= Object.entries(notifications) as NotificationMessageTupla[]

/** Obtener mensaje segun el tipo de notificacion
 * @param type Tipo de notificacion
 */
export const getNotificationMessage=(type:keyof typeof TypeNotification):string=>{
